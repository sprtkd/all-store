        ...
        <div>
            <form onSubmit={formik.handleSubmit}>
                <FormControl variant="outlined" className={classes.inputField}>
                    ...
                    />
                    <FormHelperText id="email-helper-text">{formik.touched.email && formik.errors.email}</FormHelperText>
                </FormControl>
                ...
                <FormControl variant="outlined" className={classes.inputField}>
                    <OutlinedInput
                        ...
                        className={classes.inputItem}
                    />
                    <FormHelperText id="email-helper-text">{formik.touched.password && formik.errors.password}</FormHelperText>
                </FormControl>
                <br />
                <br />
                <br />
                ...
                <Button
                    ...
                    size="medium"
                    color="primary"
                    startIcon={formik.isValid ? <ExitToAppIcon /> : <ErrorOutlineIcon style={{ color: red[500] }} />}
...
function UserRegisterDiv() {
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            registerUserApi(values.email, values.password, values.name, values.contact);
        },
    });
    const classes = useStyles();
    const [values, setValues] = React.useState({
            ...
            <form onSubmit={formik.handleSubmit}>
                ...
                <FormControl variant="outlined" className={classes.inputField}>
                    <OutlinedInput
                        ...
                        className={classes.inputItem}
                    />
                    <FormHelperText id="contact-helper-text">{formik.touched.contact && formik.errors.contact}</FormHelperText>
                </FormControl>
                <FormControl variant="outlined" className={classes.inputField}>
                    <OutlinedInput
                        id="password"
                ...
                <FormControl variant="outlined" className={classes.inputField}>
                    <OutlinedInput
                        ...
                        className={classes.inputItem}
                    />
                    <FormHelperText id="confirmPassword-helper-text">{formik.touched.confirmPassword && formik.errors.confirmPassword}</FormHelperText>
                </FormControl>
                <br />
                <br />
                <br />
                <Button
                    ...
                    size="medium"
                    color="primary"
                    startIcon={formik.isValid ? <PersonAddIcon /> : <ErrorOutlineIcon style={{ color: red[500] }} />}
                    className={classes.actionButton}
                    type="submit"
                >Register
                </Button>
    ...
    return (
        <Paper className={classes.root}>
            ...
            <div className={classes.content}>
                {values.isLogin ? <UserLoginDiv /> : <UserRegisterDiv />}
                <br />
                <Button
                    size="medium"
                    color="primary"
                ...
                >
                    {values.isLogin ? 'Not yet Registered? Go here' : 'Login Here'}
                </Button>
            </div>
        </Paper>
    );
